...
# In development this defaults to allowing everything. In production, set the
# FRONTEND_URL environment variable (e.g. https://kissanconnect.vercel.app)
# so only your actual frontend can call this API.
